...
<body>
	<nav class="site-navbar navbar navbar-default navbar-fixed-top" role="navigation">
		...
		<div class="navbar-container container-fluid">
			<div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
				...
				<ul class="breadcrumb">
					<li class="active">
						<a href="<?php echo base_url();?>admin">Majalah</a>
					</li>
					<li>
						<?php echo $breadcrumb; ?>
					</li>
	...
	<div class="site-menubar">
					...
					<ul class="site-menu">
						...
						<li class='site-menu-item has-sub'>
							<a href='javascript:void(0)' class='animsition-link'>
								...
								<i class='site-menu-icon fa fa fa-database'></i>
								<span class='site-menu-title'>Master</span>
							</a>
							<ul class='site-menu-sub'>
								<li class='site-menu-item'>
									<a href='<?php echo base_url();?>master/sekolah' class='animsition-link'>
										<span class='site-menu-title'>
											Sekolah
										</span>
									</a>
								...
								<li class='site-menu-item'>
									<a href='<?php echo base_url();?>master/pegawai' class='animsition-link'>
										<span class='site-menu-title'>
											Pegawai
										</span>
									</a>
						...
						<li class='site-menu-item'>
							<a href='<?php echo base_url();?>majalah/artikel' class='animsition-link'>
								<i class='site-menu-icon fa fa-align-left'></i>
								<span class='site-menu-title'>
									Artikel
								</span>
							</a>
						...
						<?php } ?>
						<li class='site-menu-item'>
							<a href='<?php echo base_url();?>majalah/edisi' class='animsition-link'>
								<i class='site-menu-icon fa fa-book'></i>
								<span class='site-menu-title'>
									Majalah
								</span>
							</a>
						</li>
						<?php if($admin->user_role === 'kepegum') { ?>
						<li class='site-menu-item'>
							<a href='<?php echo base_url();?>majalah/artikel' class='animsition-link'>
								<i class='site-menu-icon fa fa-align-left'></i>
								<span class='site-menu-title'>
						...
						<?php } ?>
						<li class='site-menu-item'>
							<a href='<?php echo base_url();?>majalah/grafik' class='animsition-link'>
							<span class='site-menu-title'>
								<i class='site-menu-icon fa fa fa-arrow-up'></i>
								Grafik Artikel
							</span>
							</a>
						</li>
		...
		<div class="site-menubar-footer">
			<a href="<?php echo site_url();?>admin" class="fold-show" data-placement="top" data-toggle="tooltip" data-original-title="Majalah">
	...
	<script>
		$('#modal-approve').on('show.bs.modal', function (event) {
			...
			var id = div.data('id')
			var modal = $(this)
			modal.find('#approve-artikel').attr("href", "<?php echo site_url();?>majalah/artikel/approve/" + id);
		});
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-artikel').attr("href", "<?php echo site_url();?>majalah/artikel/hapus/" + id);
			modal.find('#hapus-pegawai').attr("href", "<?php echo site_url();?>master/pegawai/hapus/" + id);
			modal.find('#hapus-jabatan').attr("href", "<?php echo site_url();?>master/jabatan/hapus/" + id);
			modal.find('#hapus-sekolah').attr("href", "<?php echo site_url();?>master/sekolah/hapus/" + id);
			modal.find('#hapus-golongan').attr("href", "<?php echo site_url();?>master/golongan/hapus/" + id);
			modal.find('#hapus-edisi').attr("href", "<?php echo site_url();?>majalah/edisi/hapus/" + id);
		});
